...
export default function Kesehatan() {
  ...
  // Find the specific items for "STOK OBAT" and "OKSIGEN"
  const stokObatData = cardData.find(item => item.title === "STOK OBAT");
  const oksigenData = cardData.find(item => item.title === "OKSIGEN");
        ...
        <div className="relative w-full max-w-3xl flex flex-col items-center">
          ...
          {stokObatData && (
            <div className="bg-white p-6 border border-gray-300 rounded-lg shadow-md w-full max-w-md mb-6">
              <h2 className="text-2xl font-bold mb-4 text-gray-800 text-center">Stok Obat Data</h2>
              <div className="bg-gray-50 p-4 border border-gray-300 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-700">{stokObatData.title}</h3>
                <p className="text-gray-600">{stokObatData.description}</p>
              </div>
            </div>
          )}
          ...
          {oksigenData && (
            <div className="bg-white p-6 border border-gray-300 rounded-lg shadow-md w-full max-w-md mb-6">
              <h2 className="text-2xl font-bold mb-4 text-gray-800 text-center">Oksigen Data</h2>
              <div className="bg-gray-50 p-4 border border-gray-300 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-700">{oksigenData.title}</h3>
                <p className="text-gray-600">{oksigenData.description}</p>
              </div>
            </div>
          )}
        </div>
