...
export default function Instrumentasi() {
  ...
  const instrumentasiData = cardData.find(item => item.title === "SENSOR PH");
        ...
        <div className="relative w-full max-w-3xl flex flex-col items-center">
          ...
          {instrumentasiData ? (
            <div className="bg-white p-6 border border-gray-300 rounded-lg shadow-md w-full max-w-md mb-6">
              <h2 className="text-2xl font-bold mb-4 text-gray-800 text-center">instrumentasi Data</h2>
              <div className="bg-gray-50 p-4 border border-gray-300 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-700">{instrumentasiData.title}</h3>
                <p className="text-gray-600">{instrumentasiData.description}</p>
              </div>
            </div>
          ) : (
