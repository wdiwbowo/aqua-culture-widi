...
export default function Navbar({ darkMode, setDarkMode }) {
    return (
        <nav className={`fixed w-full z-20 top-0 left-0 border-b ${darkMode ? 'bg-gray-900 border-gray-600' : 'bg-white border-gray-200'}`}>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/" className="flex items-center">
                    <img
                        src="https://w7.pngwing.com/pngs/82/139/png-transparent-other-aquaculture-logo-engineering-design-blue-logo-engineering-thumbnail.png"
                        className="h-8"
                        alt="SAQTI Logo"
                    />
                    <span className={`ml-3 text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>SAQTI</span>
                </Link>
                <div className="flex items-center space-x-4">
                    <ul className="flex space-x-4">
                        <li>
                            <NavLink to="/Beranda" activeClassName="active" className={`text-gray-900 dark:text-white ${darkMode ? 'text-white' : 'text-gray-900'}`}>Beranda</NavLink>
                        </li>
                        <li>
                            <NavLink to="/Profil" activeClassName="active" className={`text-gray-900 dark:text-white ${darkMode ? 'text-white' : 'text-gray-900'}`}>PROJECK SAQTI</NavLink>
                        </li>
                    </ul>
                    <button
                    ...
                    >
                        <span className={darkMode ? 'hidden' : 'inline'}>
                        ...
                        <span className={darkMode ? 'inline' : 'hidden'}>
